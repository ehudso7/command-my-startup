...
export default function ChatInterface({
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const apiMessages = [
        ...
        {
          role: 'system',
          content: 'You are a helpful AI assistant for Command My Startup, a platform that helps entrepreneurs build and grow their businesses. Provide clear, concise, and helpful responses. You can use markdown formatting in your responses.',
        },
        ...messages.map(msg => ({
          role: msg.role,
          content: msg.content,
  ...
  const availableModels = AVAILABLE_MODELS.filter(m => {
    ...
    const requiredTierLevel = tierLevels[m.tierRequirement as keyof typeof tierLevels];
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center p-6">
            ...
            <h3 className="text-lg font-medium text-gray-900 dark:text-white">Start a new conversation</h3>
